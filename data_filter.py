...
def run():
    ...
    # code in next line does not work because of the python version installed.
    # elderly = list(map(lambda worker: worker | {'elderly': worker['age'] > 69}, DATA))

    for worker in py_devs:
        print(worker)
